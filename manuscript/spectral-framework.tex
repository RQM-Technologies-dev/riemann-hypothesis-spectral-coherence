...
The main manuscript now keeps only this compressed dependency statement and does not carry a long OP/AC lemma catalog in the Stage~6 flow.
These classes specify proof burden only.
