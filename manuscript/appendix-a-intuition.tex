...
the core theorem target in the main results as a theorem target under construction.
...
manuscript vocabulary, this is the statement of
\cref{thm:core-target}, which is a draft theorem target and
is not yet proved in this manuscript version.

\subsection{A Word on Higher-Dimensional Extensions}

Some versions of the framework under exploration consider extending the analytic
setup beyond the current complex-variable spine. These exploratory directions are
not part of the formal argument in this manuscript version.
