...
\paragraph{On technical burden placement.}
Operator and analytic support burdens remain open and necessary.
The current revision keeps them in compact dependency form in the manuscript and as detailed audit items in \texttt{notes/known-gaps.md}, so the main proof program remains readable without signaling that those burdens disappeared.
